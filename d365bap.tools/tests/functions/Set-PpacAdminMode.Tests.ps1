Describe "Set-PpacAdminMode Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Set-PpacAdminMode).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter EnvironmentId' {
			$parameter = (Get-Command Set-PpacAdminMode).Parameters['EnvironmentId']
		...
		It 'Should have the expected parameter Mode' {
			$parameter = (Get-Command Set-PpacAdminMode).Parameters['Mode']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Set-PpacAdminMode).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -EnvironmentId -Mode -ProgressAction
		#>
	}
