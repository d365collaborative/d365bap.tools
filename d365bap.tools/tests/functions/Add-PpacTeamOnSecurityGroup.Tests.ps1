Describe "Add-PpacTeamOnSecurityGroup Unit Tests" -Tag "Unit" {
	...
	Describe "Ensuring unchanged command signature" {
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Add-PpacTeamOnSecurityGroup).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -EnvironmentId -Name -SecurityGroup -MembershipType -Role -TeamAdmin -ProgressAction
		#>
	}
