Describe "Set-FscmUserAccess Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Set-FscmUserAccess).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter EnvironmentId' {
			$parameter = (Get-Command Set-FscmUserAccess).Parameters['EnvironmentId']
		...
		It 'Should have the expected parameter User' {
			$parameter = (Get-Command Set-FscmUserAccess).Parameters['User']
		...
		It 'Should have the expected parameter Enabled' {
			$parameter = (Get-Command Set-FscmUserAccess).Parameters['Enabled']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Set-FscmUserAccess).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -EnvironmentId -User -Enabled -ProgressAction
		#>
	}
