Describe "Compare-BapEnvironmentD365App Unit Tests" -Tag "Unit" {
	...
	Describe "Ensuring unchanged command signature" {
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Compare-BapEnvironmentD365App).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -SourceEnvironmentId -DestinationEnvironmentId -ShowDiffOnly -GeoRegion -AsExcelOutput -ProgressAction
		#>
	}
