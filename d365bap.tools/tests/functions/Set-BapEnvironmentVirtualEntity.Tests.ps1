Describe "Set-BapEnvironmentVirtualEntity Unit Tests" -Tag "Unit" {
	...
	Describe "Ensuring unchanged command signature" {
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Set-BapEnvironmentVirtualEntity).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -EnvironmentId -Name -VisibilityOn -VisibilityOff -TrackingOn -TrackingOff -ProgressAction
		#>
	}
