Describe "Get-PpacSecurityRoleTable Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		...
		It 'Should have the expected parameter Role' {
			$parameter = (Get-Command Get-PpacSecurityRoleTable).Parameters['Role']
		...
		It 'Should have the expected parameter Name' {
			$parameter = (Get-Command Get-PpacSecurityRoleTable).Parameters['Name']
		...
		It 'Should have the expected parameter AsExcelOutput' {
			$parameter = (Get-Command Get-PpacSecurityRoleTable).Parameters['AsExcelOutput']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Get-PpacSecurityRoleTable).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -EnvironmentId -Role -Name -AsExcelOutput -ProgressAction
		#>
	}
