Describe "Get-BapEnvironmentUser Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-BapEnvironmentUser).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter EnvironmentId' {
			$parameter = (Get-Command Get-BapEnvironmentUser).Parameters['EnvironmentId']
		...
		It 'Should have the expected parameter IncludeAppIds' {
			$parameter = (Get-Command Get-BapEnvironmentUser).Parameters['IncludeAppIds']
		...
		It 'Should have the expected parameter AsExcelOutput' {
			$parameter = (Get-Command Get-BapEnvironmentUser).Parameters['AsExcelOutput']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Get-BapEnvironmentUser).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -EnvironmentId -IncludeAppIds -AsExcelOutput -ProgressAction
		#>
	}
