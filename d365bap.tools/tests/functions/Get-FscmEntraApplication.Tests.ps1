Describe "Get-FscmEntraApplication Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-FscmEntraApplication).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter EnvironmentId' {
			$parameter = (Get-Command Get-FscmEntraApplication).Parameters['EnvironmentId']
		...
		It 'Should have the expected parameter ClientId' {
			$parameter = (Get-Command Get-FscmEntraApplication).Parameters['ClientId']
		...
		It 'Should have the expected parameter AsExcelOutput' {
			$parameter = (Get-Command Get-FscmEntraApplication).Parameters['AsExcelOutput']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Get-FscmEntraApplication).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -EnvironmentId -ClientId -AsExcelOutput -ProgressAction
		#>
	}
