Describe "Add-FscmEntraApplication Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Add-FscmEntraApplication).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter EnvironmentId' {
			$parameter = (Get-Command Add-FscmEntraApplication).Parameters['EnvironmentId']
		...
		It 'Should have the expected parameter ClientId' {
			$parameter = (Get-Command Add-FscmEntraApplication).Parameters['ClientId']
		...
		It 'Should have the expected parameter Name' {
			$parameter = (Get-Command Add-FscmEntraApplication).Parameters['Name']
		...
		It 'Should have the expected parameter MappedUser' {
			$parameter = (Get-Command Add-FscmEntraApplication).Parameters['MappedUser']
			$parameter.Name | Should -Be 'MappedUser'
			$parameter.ParameterType.ToString() | Should -Be System.String
			$parameter.IsDynamic | Should -Be $False
			$parameter.ParameterSets.Keys | Should -Be '__AllParameterSets'
			$parameter.ParameterSets.Keys | Should -Contain '__AllParameterSets'
