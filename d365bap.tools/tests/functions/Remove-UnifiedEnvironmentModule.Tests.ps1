Describe "Remove-UnifiedEnvironmentModule Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Remove-UnifiedEnvironmentModule).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter EnvironmentId' {
			$parameter = (Get-Command Remove-UnifiedEnvironmentModule).Parameters['EnvironmentId']
		...
		It 'Should have the expected parameter ModuleId' {
			$parameter = (Get-Command Remove-UnifiedEnvironmentModule).Parameters['ModuleId']
			$parameter.Name | Should -Be 'ModuleId'
			$parameter.ParameterType.ToString() | Should -Be System.String
			$parameter.IsDynamic | Should -Be $False
			$parameter.ParameterSets.Keys | Should -Be '__AllParameterSets'
			$parameter.ParameterSets.Keys | Should -Contain '__AllParameterSets'
		...
		It 'Should have the expected parameter Name' {
			$parameter = (Get-Command Remove-UnifiedEnvironmentModule).Parameters['Name']
		...
		It 'Should have the expected parameter Force' {
			$parameter = (Get-Command Remove-UnifiedEnvironmentModule).Parameters['Force']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Remove-UnifiedEnvironmentModule).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -EnvironmentId -ModuleId -Name -Force -ProgressAction
		#>
	}
