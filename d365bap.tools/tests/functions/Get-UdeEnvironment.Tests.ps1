Describe "Get-UdeEnvironment Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-UdeEnvironment).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter EnvironmentId' {
			$parameter = (Get-Command Get-UdeEnvironment).Parameters['EnvironmentId']
		...
		It 'Should have the expected parameter SkipVersionDetails' {
			$parameter = (Get-Command Get-UdeEnvironment).Parameters['SkipVersionDetails']
		...
		It 'Should have the expected parameter AsExcelOutput' {
			$parameter = (Get-Command Get-UdeEnvironment).Parameters['AsExcelOutput']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Get-UdeEnvironment).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -
		__AllParameterSets -EnvironmentId -SkipVersionDetails -AsExcelOutput -ProgressAction
		#>
	}
