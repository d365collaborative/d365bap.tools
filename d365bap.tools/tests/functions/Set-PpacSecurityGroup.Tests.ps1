Describe "Set-PpacSecurityGroup Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Set-PpacSecurityGroup).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter EnvironmentId' {
			$parameter = (Get-Command Set-PpacSecurityGroup).Parameters['EnvironmentId']
		...
		It 'Should have the expected parameter SecurityGroup' {
			$parameter = (Get-Command Set-PpacSecurityGroup).Parameters['SecurityGroup']
		...
		It 'Should have the expected parameter Force' {
			$parameter = (Get-Command Set-PpacSecurityGroup).Parameters['Force']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Set-PpacSecurityGroup).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -EnvironmentId -SecurityGroup -Force -ProgressAction
		#>
	}
