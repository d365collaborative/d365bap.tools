Describe "Add-PpeSolution Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Add-PpeSolution).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter EnvironmentId' {
			$parameter = (Get-Command Add-PpeSolution).Parameters['EnvironmentId']
		...
		It 'Should have the expected parameter Publisher' {
			$parameter = (Get-Command Add-PpeSolution).Parameters['Publisher']
			$parameter.Name | Should -Be 'Publisher'
			$parameter.ParameterType.ToString() | Should -Be System.String
			$parameter.IsDynamic | Should -Be $False
			$parameter.ParameterSets.Keys | Should -Be '__AllParameterSets'
			$parameter.ParameterSets.Keys | Should -Contain '__AllParameterSets'
		...
		It 'Should have the expected parameter Name' {
			$parameter = (Get-Command Add-PpeSolution).Parameters['Name']
		...
		It 'Should have the expected parameter SystemName' {
			$parameter = (Get-Command Add-PpeSolution).Parameters['SystemName']
			$parameter.Name | Should -Be 'SystemName'
			$parameter.ParameterType.ToString() | Should -Be System.String
			$parameter.IsDynamic | Should -Be $False
			$parameter.ParameterSets.Keys | Should -Be '__AllParameterSets'
			$parameter.ParameterSets.Keys | Should -Contain '__AllParameterSets'
		...
		It 'Should have the expected parameter Version' {
			$parameter = (Get-Command Add-PpeSolution).Parameters['Version']
		...
		It 'Should have the expected parameter Description' {
			$parameter = (Get-Command Add-PpeSolution).Parameters['Description']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Add-PpeSolution).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -EnvironmentId -Publisher -Name -SystemName
		__AllParameterSets -EnvironmentId -Publisher -Name -SystemName -Version -Description -ProgressAction
		#>
	}
