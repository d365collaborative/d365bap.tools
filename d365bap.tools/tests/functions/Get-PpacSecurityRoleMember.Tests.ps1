Describe "Get-PpacSecurityRoleMember Unit Tests" -Tag "Unit" {
	...
	Describe "Ensuring unchanged command signature" {
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Get-PpacSecurityRoleMember).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -EnvironmentId -Role -User -IncludePpacApplications -AsExcelOutput -ProgressAction
		#>
	}
