Describe "Get-BapEnvironmentSolution Unit Tests" -Tag "Unit" {
	...
	Describe "Ensuring unchanged command signature" {
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Get-BapEnvironmentSolution).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -EnvironmentId -SolutionId -IncludeManaged -AsExcelOutput -ProgressAction
		#>
	}
