Describe "Compare-BapEnvironmentUser Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Compare-BapEnvironmentUser).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter SourceEnvironmentId' {
			$parameter = (Get-Command Compare-BapEnvironmentUser).Parameters['SourceEnvironmentId']
		...
		It 'Should have the expected parameter DestinationEnvironmentId' {
			$parameter = (Get-Command Compare-BapEnvironmentUser).Parameters['DestinationEnvironmentId']
		...
		It 'Should have the expected parameter ShowDiffOnly' {
			$parameter = (Get-Command Compare-BapEnvironmentUser).Parameters['ShowDiffOnly']
		...
		It 'Should have the expected parameter IncludeAppIds' {
			$parameter = (Get-Command Compare-BapEnvironmentUser).Parameters['IncludeAppIds']
		...
		It 'Should have the expected parameter AsExcelOutput' {
			$parameter = (Get-Command Compare-BapEnvironmentUser).Parameters['AsExcelOutput']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Compare-BapEnvironmentUser).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -SourceEnvironmentId -DestinationEnvironmentId -ShowDiffOnly -IncludeAppIds -AsExcelOutput -ProgressAction
		#>
	}
