Describe "Get-UdeXrefDb Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-UdeXrefDb).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Name' {
			$parameter = (Get-Command Get-UdeXrefDb).Parameters['Name']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Get-UdeXrefDb).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -
		__AllParameterSets -Name -ProgressAction
		#>
	}
