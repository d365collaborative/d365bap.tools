Describe "Remove-UdeEnvironmentModel Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Remove-UdeEnvironmentModel).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter EnvironmentId' {
			$parameter = (Get-Command Remove-UdeEnvironmentModel).Parameters['EnvironmentId']
		...
		It 'Should have the expected parameter Model' {
			$parameter = (Get-Command Remove-UdeEnvironmentModel).Parameters['Model']
		...
		It 'Should have the expected parameter WorkFolder' {
			$parameter = (Get-Command Remove-UdeEnvironmentModel).Parameters['WorkFolder']
			$parameter.Name | Should -Be 'WorkFolder'
			$parameter.ParameterType.ToString() | Should -Be System.String
			$parameter.IsDynamic | Should -Be $False
			$parameter.ParameterSets.Keys | Should -Be '__AllParameterSets'
			$parameter.ParameterSets.Keys | Should -Contain '__AllParameterSets'
		...
		It 'Should have the expected parameter WaitForCompletion' {
			$parameter = (Get-Command Remove-UdeEnvironmentModel).Parameters['WaitForCompletion']
		...
		It 'Should have the expected parameter DownloadLog' {
			$parameter = (Get-Command Remove-UdeEnvironmentModel).Parameters['DownloadLog']
		...
		It 'Should have the expected parameter Force' {
			$parameter = (Get-Command Remove-UdeEnvironmentModel).Parameters['Force']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Remove-UdeEnvironmentModel).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -EnvironmentId -Model
		__AllParameterSets -EnvironmentId -Model -WorkFolder -WaitForCompletion -DownloadLog -Force -ProgressAction
		#>
	}
