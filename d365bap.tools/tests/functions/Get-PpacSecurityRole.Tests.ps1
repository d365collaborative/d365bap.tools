Describe "Get-PpacSecurityRole Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-PpacSecurityRole).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter EnvironmentId' {
			$parameter = (Get-Command Get-PpacSecurityRole).Parameters['EnvironmentId']
		...
		It 'Should have the expected parameter Name' {
			$parameter = (Get-Command Get-PpacSecurityRole).Parameters['Name']
		...
		It 'Should have the expected parameter IncludeAll' {
			$parameter = (Get-Command Get-PpacSecurityRole).Parameters['IncludeAll']
		...
		It 'Should have the expected parameter AsExcelOutput' {
			$parameter = (Get-Command Get-PpacSecurityRole).Parameters['AsExcelOutput']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Get-PpacSecurityRole).Parameters['ProgressAction']
