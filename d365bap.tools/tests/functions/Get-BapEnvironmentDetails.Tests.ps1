Describe "Get-BapEnvironmentDetails Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-BapEnvironmentDetails).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter EnvironmentId' {
			$parameter = (Get-Command Get-BapEnvironmentDetails).Parameters['EnvironmentId']
		...
		It 'Should have the expected parameter AsExcelOutput' {
			$parameter = (Get-Command Get-BapEnvironmentDetails).Parameters['AsExcelOutput']
