Describe "Remove-PpeSolution Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Remove-PpeSolution).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter EnvironmentId' {
			$parameter = (Get-Command Remove-PpeSolution).Parameters['EnvironmentId']
		...
		It 'Should have the expected parameter Name' {
			$parameter = (Get-Command Remove-PpeSolution).Parameters['Name']
		...
		It 'Should have the expected parameter Force' {
			$parameter = (Get-Command Remove-PpeSolution).Parameters['Force']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Remove-PpeSolution).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -EnvironmentId -Name -Force -ProgressAction
		#>
	}
