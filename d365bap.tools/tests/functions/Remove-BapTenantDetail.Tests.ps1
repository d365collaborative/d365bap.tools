Describe "Remove-BapTenantDetail Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Remove-BapTenantDetail).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Id' {
			$parameter = (Get-Command Remove-BapTenantDetail).Parameters['Id']
		...
		It 'Should have the expected parameter Force' {
			$parameter = (Get-Command Remove-BapTenantDetail).Parameters['Force']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Remove-BapTenantDetail).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -Id -Force -ProgressAction
		#>
	}
