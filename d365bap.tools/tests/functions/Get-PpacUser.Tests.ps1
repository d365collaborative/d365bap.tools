Describe "Get-PpacUser Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-PpacUser).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter EnvironmentId' {
			$parameter = (Get-Command Get-PpacUser).Parameters['EnvironmentId']
		...
		It 'Should have the expected parameter IncludeAppIds' {
			$parameter = (Get-Command Get-PpacUser).Parameters['IncludeAppIds']
		...
		It 'Should have the expected parameter AsExcelOutput' {
			$parameter = (Get-Command Get-PpacUser).Parameters['AsExcelOutput']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Get-PpacUser).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -EnvironmentId -User -IncludeAppIds -AsExcelOutput -ProgressAction
		#>
	}
