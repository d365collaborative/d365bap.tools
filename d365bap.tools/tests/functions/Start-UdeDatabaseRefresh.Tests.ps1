Describe "Start-UdeDatabaseRefresh Unit Tests" -Tag "Unit" {
	...
	Describe "Ensuring unchanged command signature" {
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Start-UdeDatabaseRefresh).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -SourceEnvironmentId
		__AllParameterSets -SourceEnvironmentId -TargetEnvironmentId -CopyType -IncludeAuditData -AdvancedFnO -ProgressAction
		#>
	}
