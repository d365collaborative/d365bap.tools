Describe "Set-PpacSecurityRoleTable Unit Tests" -Tag "Unit" {
	...
	Describe "Ensuring unchanged command signature" {
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Set-PpacSecurityRoleTable).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -EnvironmentId -Role -Table -Create -Read -Write -Delete -Append -AppendTo -Assign -Share -ProgressAction
		#>
	}
