Describe "Get-UdeEnvironmentModel Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-UdeEnvironmentModel).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter EnvironmentId' {
			$parameter = (Get-Command Get-UdeEnvironmentModel).Parameters['EnvironmentId']
		...
		It 'Should have the expected parameter Name' {
			$parameter = (Get-Command Get-UdeEnvironmentModel).Parameters['Name']
		...
		It 'Should have the expected parameter LatestOnly' {
			$parameter = (Get-Command Get-UdeEnvironmentModel).Parameters['LatestOnly']
		...
		It 'Should have the expected parameter AsExcelOutput' {
			$parameter = (Get-Command Get-UdeEnvironmentModel).Parameters['AsExcelOutput']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Get-UdeEnvironmentModel).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -EnvironmentId -Name -LatestOnly -AsExcelOutput -ProgressAction
		#>
	}
