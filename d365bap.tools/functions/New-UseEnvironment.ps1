...
<#
    ...
    .EXAMPLE
        PS C:\> New-UseEnvironment -Name "MyUseEnv" -Location "Europe" -FnoTemplate D365_FinOps_Finance
    ...
    .EXAMPLE
        PS C:\> New-UseEnvironment -Name "MyUseEnv" -Location "Europe" -Region WestEurope -FnoTemplate D365_FinOps_Finance
    ...
    .EXAMPLE
        PS C:\> New-UseEnvironment -Name "MyUseEnv" -CustomDomainName "my-use-env" -Location "Europe" -FnoTemplate D365_FinOps_Finance
    ...
    .EXAMPLE
        PS C:\> New-UseEnvironment -Name "MyUseEnv" -Location "Europe" -FnoTemplate D365_FinOps_Finance -NoDemoDb -Version 10.0.45.7
        This will create a new USE environment named "MyUseEnv" in the "Europe" location using the specified Finance and Operations template.
    ...
    .EXAMPLE
        PS C:\> New-UseEnvironment -Name "MyUseEnv" -Location "Europe" -FnoTemplate D365_FinOps_Finance -SecurityGroupId "12345678-90ab-cdef-1234-567890abcdef"
    ...
    process {
        ...
        $config = [PsCustomObject][ordered]@{
            ...
            properties = [PsCustomObject][ordered]@{
                ...
                description               = ""
                displayName               = $Name
                environmentSku            = "Sandbox" # USE - Can only be Sandbox
                linkedEnvironmentMetadata = [PsCustomObject][ordered]@{
                    ...
                    templateMetadata = [PsCustomObject][ordered]@{
                        PostProvisioningPackages = [PsCustomObject]@([PsCustomObject][ordered]@{
                                ...
                                parameters            = "DevToolsEnabled=false|DemoDataEnabled=$(-not $NoDemoDb)"
                            })
                    }
