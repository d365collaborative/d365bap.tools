...
#>
function Get-BapDeployLocation {
    [CmdletBinding()]
    ...
    process {
        ...
        if ($AsExcelOutput) {
            $resCol | Export-Excel -WorksheetName "Get-BapDeployLocation" `
