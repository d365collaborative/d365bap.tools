...
```
Get-PpeSolutionHistory [-EnvironmentId] <String> [[-Name] <String>] [-AsExcelOutput]
...
### EXAMPLE 1
```
Get-PpeSolutionHistory -EnvironmentId eec2c11a-a4c7-4e1d-b8ed-f62acc9c74c6
```
...
### EXAMPLE 2
```
Get-PpeSolutionHistory -EnvironmentId eec2c11a-a4c7-4e1d-b8ed-f62acc9c74c6 -Name "*invoice*"
```
...
### EXAMPLE 3
```
Get-PpeSolutionHistory -EnvironmentId eec2c11a-a4c7-4e1d-b8ed-f62acc9c74c6 -AsExcelOutput
```
